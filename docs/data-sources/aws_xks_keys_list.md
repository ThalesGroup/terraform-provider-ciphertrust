...
- `keys` (Attributes List) List of AWS XKS keys matching the given filters. (see [below for nested schema](#nestedatt--keys))
...
- `source_key_tier` (String) Source key tier for AWS XKS key.
