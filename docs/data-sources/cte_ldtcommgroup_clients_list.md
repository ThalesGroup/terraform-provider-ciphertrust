...
- `limit` (Number) Maximum number of clients to return. If unset, all clients in the LDT communication group are returned (a warning is emitted if the result set is large).
