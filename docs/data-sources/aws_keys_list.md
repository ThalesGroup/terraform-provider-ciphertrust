...
subcategory: ""
description: |-
  Use this data source to retrieve a list of AWS keys. Supply a filters map of key/value pairs matching the CipherTrust Manager API query parameters for listing AWS keys (such as region, alias, or keyid). Set limit = "-1" to return all matching keys.
---
