...
description: |-
  Configures a CipherTrust Manager (CM) instance or cluster, or a CipherTrust Data Security Platform as a Service (CDSPaaS) tenant, and manages cloud key resources protected by these platforms.
---
...
Resources that manage CipherTrust Manager infrastructure are platform-managed in CDSPaaS and fail at
plan time; they are listed in the CDSPaaS example above.
