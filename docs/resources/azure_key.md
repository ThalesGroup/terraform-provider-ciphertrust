...
- `name` (String) (Updateable) Name for the key unless a key is being restored to a different vault. If the value of this parameter is changed, the current key will be destroyed and a new key created.
