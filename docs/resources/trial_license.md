...
page_title: "ciphertrust_trial_license Resource - ciphertrust"
subcategory: ""
description: |-
...
- `license_type` (String) The name, type, or substring identifier of the trial license to activate (e.g. 'CCKM', 'CTE', 'KMIP'). Required if multiple trial licenses exist on the CipherTrust Manager appliance.
