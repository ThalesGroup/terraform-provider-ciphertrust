# Create a Ciphertrust Key and add it to an OCI External Vault

This example shows how to:
- Create an OCI Cloud connection
- Create an OCI external vault allowing only Ciphertrust keys
- Create a Ciphertrust AES Key and add it to the external vault
