# Schedule Rotation of Google Cloud Keys using CipherTrust Manager as the Key Source

This example shows how to:
- Create a connection to Google Cloud
- Configure a scheduled rotation job for Google Cloud keys using CipherTrust Manager as the key source
