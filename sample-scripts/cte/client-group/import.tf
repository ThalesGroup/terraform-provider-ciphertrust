...
/*
Here we need three different import blocks as they are managed by differnet resources and use them as per your need.
*/

/*
import {
    to = ciphertrust_cte_client_group.label1
    id = "client_group_id"
}

import {
    to = ciphertrust_cte_clientgroup_guardpoint.label1
    id = "client_group_id"
}

import {
    to = ciphertrust_cte_clientgroup_designatedprimaryset.label1
    id = "client_group_id:designated_prinary_set_id"
}
*/
