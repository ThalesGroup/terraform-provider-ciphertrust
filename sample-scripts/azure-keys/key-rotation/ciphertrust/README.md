# Schedule Rotation of Azure Keys using CipherTrust Manager as the Key Source

This example shows how to:
- Create a connection to Azure
- Configure a scheduled rotation job for Azure key using CipherTrust Manager as the key source
