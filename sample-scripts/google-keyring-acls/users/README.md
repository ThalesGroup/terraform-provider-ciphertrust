# Add access control for a CipherTrust user to a Google Cloud Keyring

This example shows how to:
- Create a Google Cloud connection
- Add a Google keyring
- Create a user and an ACL (Access Control List) for the user on the keyring   

These steps explain how to:
- Configure CipherTrust Manager Provider parameters required to run the examples
- Configure Google Cloud parameters required to run the example
- Run the example
