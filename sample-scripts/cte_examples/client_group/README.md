# Create CTE client group on Ciphertrust Manager.

This example shows how to:
- Create a client group on Ciphertrust Manager.
...
resource "ciphertrust_cte_clientgroup" "clientgroup" {
        ...
        description = "client_group description"   
        communication_enabled =   false
        password_creation_method =   "password_creation_type",
        profile_id = "client_profile_name"
